...
/*
 * 根据传人的供应商和url实时取库存价格等信息
 */
app.get('/inforbyurl',function(request,response){		
	var tempvalue =  request.param("supplier")+".info(request.param(\"url\"),function(data){response.json(data);}) ;" 
	eval(tempvalue);	
})
